...
const QRCard = ({ onClose }) => (
  <div className="relative p-6 text-white rounded-lg w-72">
    ...
    <div className="relative z-10 flex justify-between items-center">
      ...
      <p className="text-xs tracking-custom-150 font-lato-regular">GET A QR CODE</p>
    ...
    <div className="relative z-10 flex flex-col items-center mb-2">
      ...
      <p className="text-sm tracking-custom-150 font-lato-regular">Revision Files</p>
    </div>
    <div className="relative z-10">
      {qrActions.map((item, index) => (
        <div key={index} className="flex items-center gap-x-4 justify-center mt-4">
          <div>
            <p className="text-sm tracking-custom-150 mt-1 font-lato-regular">{item.text}</p>
          </div>
          <div>
      ...
      <div className="flex items-center gap-x-2 mt-5 justify-center">
        ...
        <p className="ml-2 text-xs tracking-custom-150 font-lato-regular">SET PASSWORD</p>
      </div>
    </div>
    <div className="relative flex items-center justify-end mt-5">
      <p className="text-10px text-gray-400 tracking-custom-150 font-lato-regular">Optional</p>
      <Image
        src="/assets/Tick.svg"
        alt="Tick Icon"
        width={48}
